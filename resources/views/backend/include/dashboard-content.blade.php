            ...
            <div class="card-statistic-4">
                <div class="align-items-center justify-content-between">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                            <div class="banner-img p-1">
                                <img src="{{ asset('backend/assets/img/banner/category.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-statistic-4">
                <div class="align-items-center justify-content-between">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                            <div class="banner-img">
                                <img src="{{ asset('backend/assets/img/banner/6.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-5">
                            <div class="card-content">
                                ...
                                {{-- <p class="mb-0"><span class="col-green"><a href="">Go to projects</a></span>
                                    </p> --}}
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
            ...
            <div class="card-statistic-4">
                <div class="align-items-center justify-content-between">
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-5">
                            <div class="card-content">
                                <h5 class="font-15">Client</h5>
                                <h2 class="mb-3 font-18">0</h2>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                            <div class="banner-img">
                                <img src="{{ asset('backend/assets/img/banner/client.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-statistic-4">
                <div class="align-items-center justify-content-between">
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-5">
                            <div class="card-content">
                                <h5 class="font-15">Partner</h5>
                                <h2 class="mb-3 font-18">0</h2>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                            <div class="banner-img">
                                <img src="{{ asset('backend/assets/img/banner/partner.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-statistic-4">
                <div class="align-items-center justify-content-between">
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-5">
                            <div class="card-content">
                                <h5 class="font-15">Portfolio</h5>
                                <h2 class="mb-3 font-18">0</h2>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                            <div class="banner-img">
                                <img src="{{ asset('backend/assets/img/banner/portfolio.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
